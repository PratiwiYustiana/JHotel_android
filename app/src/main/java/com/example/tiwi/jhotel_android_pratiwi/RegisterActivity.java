        ...
        buttonRegis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V) {
                ...
                if(TextUtils.isEmpty(name)){
                    nameRegis.setError( "Masukkan nama" );
                } else if(TextUtils.isEmpty(email)){
                    emailRegis.setError("Masukkan email");
                }else if(TextUtils.isEmpty(pass)){
                    passRegis.setError("Masukkan password");
                }else{
                        ...
                        public void onResponse(String response) {
                            try{ JSONObject jsonResponse = new JSONObject(response);
                                if(jsonResponse!=null) {
                                    ...
                                    builder.setMessage("Registrasi success.") .create() .show();
                                    Intent Intent3 = new Intent(RegisterActivity.this, LoginActivity.class);
                                    startActivity(Intent3);
                                }
                            } catch (JSONException e) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                                builder.setMessage("Registrasi failed.") .create() .show();
                            }
                        }
                    };
